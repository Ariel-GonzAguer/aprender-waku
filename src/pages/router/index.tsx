...
export default function Router() {
  ...
  return (
    <section className='flex flex-col justify-center items-center my-10 text-xl'>
      ...
      <button className='text-black py-5 px-4 mb-4 border-2 border-red-600 bg-amber-400 rounded' onClick={() => router.push('/temas/temas/navegacion')}>Ir al tema 4-navegación</button>
