...
export default async function HomePage() {
  return (
    <section id='página-inicial' className="flex flex-col justify-center items-center text-center text-balance flex-1 w-full">
      ...
      <p className="mb-4">Esta es la primera guía en español para aprender el framework minimalista, basado en React Server Componentes <span className="font-bold">Waku</span>.</p>
